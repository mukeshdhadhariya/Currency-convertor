...
import InputBox from './componenet/Inputbox'
...
function App() {
  ...
  const options =["USD","INR","AUD","BGN","HKD","HRK","HUF","PHP","GBP","JPY","CAD","DKK"]
            ...
            <div className="w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-lg bg-white/30">
                ...
                >
                    ...
                    <div className="relative w-full h-0.5">
                        <button
                            type="button"
                            className="absolute left-1/2 -translate-x-1/2 -translate-y-1/2 border-2 border-white rounded-md bg-green-400  px-2 py-0.5"
                            onClick={swap}
                        >
                            swap
                        </button>
